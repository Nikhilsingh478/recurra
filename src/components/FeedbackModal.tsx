...
/* ── Emoji-based rating (replaces cheap stars) ── */
const RATINGS = [
...
const EmojiRating = ({ value, onChange }: { value: number; onChange: (v: number) => void }) => {
  const [hover, setHover] = useState(0);
  const active = hover || value;

  return (
    <div className="flex items-center justify-between gap-1 rounded-2xl p-1.5"
      ...
      {RATINGS.map((r) => {
        ...
        return (
          <button
            ...
            className="relative flex flex-col items-center gap-1 rounded-xl px-3 py-2.5 transition-all duration-200 ease-out"
            style={{
              flex: 1,
          ...
          >
            ...
            <span className="text-[9px] font-medium tracking-wider uppercase transition-colors duration-200"
              style={{ color: isSelected ? "rgba(147,180,248,0.9)" : isActive ? "rgba(255,255,255,0.5)" : "rgba(255,255,255,0.2)" }}>
              {r.label}
            </span>
          </button>
        );
...
const FeedbackModal = () => {
  ...
  return (
    <>
      ...
      {/* Centering wrapper — flex-based, no transform centering */}
      <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 pointer-events-none">
        <div
          ...
          style={{
            maxWidth: 440,
            background: "linear-gradient(170deg, rgba(15,23,42,0.98) 0%, rgba(8,12,24,0.99) 100%)",
            border: "1px solid rgba(255,255,255,0.07)",
            borderRadius: 20,
            padding: 0,
            boxShadow: "0 0 0 1px rgba(255,255,255,0.03), 0 25px 80px -12px rgba(0,0,0,0.8), 0 0 60px -20px rgba(59,111,212,0.15)",
        ...
        >
          ...
          <div className="h-px w-full rounded-t-[20px] overflow-hidden">
            <div className="h-full w-full"
              style={{ background: "linear-gradient(90deg, transparent 0%, rgba(59,111,212,0.4) 30%, rgba(147,180,248,0.3) 70%, transparent 100%)" }} />
          </div>

          <div className="px-7 pt-7 pb-6 sm:px-8 sm:pt-8 sm:pb-7">
            {sent ? (
              <div className="flex flex-col items-center justify-center py-10 gap-4">
                ...
                <div className="text-center">
                  <p className="font-heading text-lg font-semibold text-white/90">Thanks for your feedback</p>
                  <p className="text-sm mt-1" style={{ color: "rgba(255,255,255,0.4)" }}>It helps us make Recurra better.</p>
                </div>
              </div>
            ) : (
              <>
                ...
                <div className="mb-6">
                  <div className="flex items-center gap-2 mb-3">
                    <div className="w-7 h-7 rounded-lg flex items-center justify-center"
                      ...
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#7ba4f0" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" />
                      </svg>
                    </div>
                    <span className="text-[10px] font-bold uppercase tracking-[0.15em]"
                      style={{ color: "rgba(147,180,248,0.6)" }}>Feedback</span>
                  </div>
                ...
                {/* Rating */}
                <div className="mb-5">
                  <label className="block text-[10px] font-semibold uppercase tracking-[0.14em] mb-2.5"
                ...
                <div className="space-y-4 mb-5">
                  ...
                  <div>
                    <label className="block text-[10px] font-semibold uppercase tracking-[0.14em] mb-2"
                      style={{ color: "rgba(255,255,255,0.3)" }}>
                      Email <span style={{ color: "rgba(255,255,255,0.15)" }}>· optional</span>
                    </label>
                    <input
                      type="email"
                      value={email}
